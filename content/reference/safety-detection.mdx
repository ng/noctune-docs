...
You can mute the indicator on any individual encounter if it was a false positive (Encounter → three-dot menu → **Unflag**). The underlying audio preservation and lock stay in place — unflagging only hides the indicator. You can't opt out account-wide, because the protection exists *for* you.
